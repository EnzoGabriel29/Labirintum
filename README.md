...
O próximo passo é guardar essas informações em memória. O usuário pode pausar a gravação dos dados ou parar o registro desses dados. Os dados são registrados com data e hora de registro (no formato DD/MM HH:MM:SS) e com os valores de aceleração de cada eixo do dispositivo.

## TO DO

- Criar menu de configuração, onde o usuário pode escolher o intervalo de gravação.
